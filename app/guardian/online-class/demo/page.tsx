...
import { Video, Mic, VideoOff, ScreenShare, Paperclip, Send, MessageSquare } from "lucide-react"

type Message = { id: number; sender: string; text: string; time: string }

export default function GuardianOnlineClassDemoPage() {
  const [messages, setMessages] = useState<Message[]>([
    { id: 1, sender: "Teacher", text: "We will start with algebra practice today.", time: "5:02 PM" },
    { id: 2, sender: "You", text: "Please focus on quadratic equations.", time: "5:03 PM" },
  ])
      ...
      <div className="max-w-6xl mx-auto space-y-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-muted-foreground">Monitor live class, chat, and share attachments</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
          <Card className="lg:col-span-2">
            <CardHeader className="pb-2">
              ...
              <CardDescription className="text-xs">Teacher: Tahmid Afsar Shapno | Student: Arif Hossain</CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardDescription className="text-xs">Talk to the teacher during class</CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
