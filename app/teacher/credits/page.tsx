...
const history = [
  { id: "CR-103", credits: 15, amount: 800, date: "Nov 20, 2025", status: "paid" },
  { id: "CR-102", credits: 5, amount: 300, date: "Oct 15, 2025", status: "paid" },
  { id: "CR-101", credits: 5, amount: 300, date: "Sep 10, 2025", status: "paid" },
]
    ...
    <DashboardLayout userType="teacher" userName="Tahmid Afsar Shapno" userImage="/teacher-profile.png">
      <div className="max-w-6xl mx-auto space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-lg font-semibold text-foreground">Bid Credits</h1>
            <p className="text-xs text-muted-foreground">Purchase credits to place bids. 1 credit = 1 bid.</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <Card className="border-border/80">
            <CardContent className="p-4 space-y-2">
              ...
              <p className="text-[11px] text-muted-foreground">40% of credits used</p>
          ...
          <Card className="border-border/80">
            <CardContent className="p-4 space-y-2">
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                Refund credits if a tuition is cancelled
              </div>
              <p className="text-[11px] text-muted-foreground">Applied automatically to all bids</p>
            </CardContent>
          </Card>
          <Card className="border-border/80">
            <CardContent className="p-4 space-y-2">
              <p className="text-xs text-muted-foreground">Tip</p>
              <p className="text-sm text-foreground">Bid on local Dhaka Board tuitions for better match rate.</p>
            </CardContent>
          </Card>
        </div>
          ...
          {packs.map((pack) => (
            ...
            >
              ...
              <CardContent className="space-y-2">
                ...
                <p className="text-[11px] text-muted-foreground">Use for {pack.credits} bids</p>
