...
const classes = [
  {
    ...
    guardian: "Farzana Hossain",
    time: "Today, 5:00 PM",
    duration: "60 mins",
    mode: "Online",
    joinLink: "/teacher/online-class/demo",
  },
  {
    id: "class-2",
    title: "HSC Physics - Numericals",
    student: "Nusrat Jahan",
    guardian: "Shafiqul Islam",
...
export default function TeacherOnlineClassPage() {
  return (
      ...
      <div className="max-w-6xl mx-auto space-y-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-muted-foreground">Join live sessions and share links with students</p>
          </div>
        </div>
        ...
        <Card>
          <CardHeader className="pb-2">
            ...
            <CardDescription className="text-xs">Keep your meeting links handy</CardDescription>
          </CardHeader>
              ...
              >
                <div className="flex items-start gap-3">
                  <Avatar className="h-12 w-12">
                    <AvatarImage src="/placeholder.svg" alt={item.student} />
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-muted-foreground">Student: {item.student} | Guardian: {item.guardian}</p>
